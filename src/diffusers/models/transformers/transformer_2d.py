...
class Transformer2DModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        self.timesteps_embedding_num_channels = timesteps_embedding_num_channels
        ...
        if norm_type == "ada_norm_single":
            ...
            self.adaln_single = AdaLayerNormSingle(
                inner_dim,
                projection_class_embeddings_input_dim=self.projection_class_embeddings_input_dim,
                timesteps_embedding_num_channels=self.timesteps_embedding_num_channels,
            )
