...
if is_torch_available():
    ...
    _import_structure["autoencoders.autoencoder_kl_kvae_video"] = [
    ...
    _import_structure["autoencoders.autoencoder_longcat_audio_dit"] = [
        "LongCatAudioDiTVae"
    ]
    ...
    _import_structure["controlnets.controlnet_flux2"] = ["Flux2ControlNetModel"]
    ...
    _import_structure["transformers.transformer_ernie_image"] = [
    ...
    _import_structure["transformers.transformer_longcat_audio_dit"] = [
