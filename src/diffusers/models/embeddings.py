...
class CombinedTimestepVectorEmbeddings(nn.Module):
    """
    Conbined timestep and vector embeddings.
    """
    ...
    def __init__(
        ...
        if projection_class_embeddings_input_dim is not None:
            ...
            self.vector_embedder = TimestepEmbedding(
    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.use_additional_conditions:
            conditioning = timesteps_emb + self.vector_embedder(vector_conditioning).to(
                dtype=hidden_dtype
            )
        else:
